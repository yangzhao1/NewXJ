...
import com.zq.xinjiang.approval.fragment.ShouFeiLieBiaoFragment;
import com.zq.xinjiang.approval.utils.Config;

public class ShouFeiLieBiaoActivity extends FragmentActivity {
	/**
	 * 收费列表
	 */
	private ShouFeiLieBiaoActivity instance;
...
//		this.requestWindowFeature(Window.FEATURE_NO_TITLE);// 去掉标题栏
		...
		// 把页面添加到ViewPager里
		totalFragment.add(new ShouFeiLieBiaoFragment());
