...
public class CrashHandler implements UncaughtExceptionHandler {
	...
	private HashMap<String, String> obtainSimpleInfo(Context context) {
		...
		PackageManager mPackageManager = context.getPackageManager();// 获取应用程序信息
	...
	private String obtainExceptionInfo(Throwable throwable) {
		StringWriter mStringWriter = new StringWriter();// 字符流的一个对象
		PrintWriter mPrintWriter = new PrintWriter(mStringWriter);
		throwable.printStackTrace(mPrintWriter);// 将异常信息转化成字符串
		mPrintWriter.close();
	...
	private String savaInfoToSD(Context context, Throwable ex) {
		...
		if (Environment.getExternalStorageState().equals(
			...
			File dir = new File(SDCARD_ROOT + File.separator + "ylpj/crash"
					+ File.separator);
