...
public class FaSongDuanXiaoXiActivity extends BaseAproActivity {
	/**
	 * 发消息
	 */
	private FaSongDuanXiaoXiActivity instance;
...
//		actionBarReturnText.setText("发送短消息");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == 123) {
			...
			tv_name.setText(vString1.subSequence(1, vString1.length() - 1));
		}
	}
	...
	private void fsdxx() {
		...
		if (MSimpleHttpUtil.isCheckNet(FaSongDuanXiaoXiActivity.this)) {
