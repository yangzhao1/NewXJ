...
import com.zq.xinjiang.approval.fragment.GeRenBanJianFragment;
import com.zq.xinjiang.approval.utils.Config;

public class GeRenBanJianActivity extends FragmentActivity {
	/**
	 * 个人办件
	 */
	private GeRenBanJianActivity instance;
...
//		this.requestWindowFeature(Window.FEATURE_NO_TITLE);// 去掉标题栏
		...
		// 把页面添加到ViewPager里
		totalFragment.add(new GeRenBanJianFragment());
