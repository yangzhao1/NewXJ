...
public class ChaKanYiFaXiaoXiActivity extends BaseAproActivity {
	/**
	 * 查看已回复消息
	 */
	private ChaKanYiFaXiaoXiActivity instance;
...
//		requestWindowFeature(Window.FEATURE_CUSTOM_TITLE);
		setContentView(R.layout.activity_ckyfxx);
		// 设置标题为某个layout
...
//		actionBarReturnText.setText("查看短消息");
	...
	private void znxxxq() {
		...
		if (MSimpleHttpUtil.isCheckNet(ChaKanYiFaXiaoXiActivity.this)) {
			dialog = ProgressDialog.show(ChaKanYiFaXiaoXiActivity.this, null, "正在加载中...");
