...
public class G_NotificateActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener{

    private String notificate = "通知公告";
    ...
    private void refreshRecyclerView(final List<Map> list){
        ...
        adapter.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent in = new Intent(G_NotificateActivity.this,G_NewsDetails.class);
