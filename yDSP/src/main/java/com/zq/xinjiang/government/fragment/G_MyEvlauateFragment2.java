...
public class G_MyEvlauateFragment2 extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void getUrlData(String mod,String act,String userid,String state,String pingjia,int pageindexs){
        ...
        Dialog dialog = null;
        String url = Allports.getMyEvaluateUrl(mod,act,userid,state,pingjia,"100",pagesize+"",pageindexs+"");
        LogUtil.recordLog("我的评价列表："+ url);
