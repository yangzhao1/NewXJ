...
import com.zq.xinjiang.government.adapter.MyCollectAdapter;
...
public class G_MyCollectActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener{
    private TextView titleText,back;
    private String titlestr = "我的收藏";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.g_mycollectmain);
        setStatusColor();
        init();
    }
    ...
    private void init(){
        ...
        swipe.setColorSchemeResources(R.color.theme_color,R.color.white,R.color.gray);
        //加载更多
        recycler_progress = LayoutInflater.from(this).inflate(R.layout.recycler_progress,null);

        getUrlData("op","collectionoflist",loginid,pageindex);
    }
    ...
    private void getUrlData(String mod,String act,String userid,int pager){
        ...
        String url = Allports.getMyCollectionUrl(mod,act,userid,pagesize+"",pager + "");
        Log.e("我的收藏列表：",url);
                    ...
                    try {
                        ...
                        if (errno == 0) {
                            ...
                            for (int i =0;i<array.length();i++){
                                ...
                                map.put("itemdefid",obj.getString("itemdefid"));
                                map.put("time",obj.getString("collectiontime"));
                                map.put("orgname",obj.getString("orgname"));
                                map.put("itemcode",obj.getString("itemcode"));
    ...
    private void refreshRecyclerView(final List<Map> list){
        ...
        if (flag){
            layoutManager = new LinearLayoutManager(G_MyCollectActivity.this);
            recyclerView.setLayoutManager(layoutManager);
            adapter = new MyCollectAdapter(G_MyCollectActivity.this,list,loginid);
        ...
        adapter.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if(list.size()!=0){
                    Intent in = new Intent(G_MyCollectActivity.this,G_ItemDetailsActivity.class);
                    in.putExtra("id",list.get(i).get("itemdefid").toString());
                    startActivity(in);
                }
            }
        });
