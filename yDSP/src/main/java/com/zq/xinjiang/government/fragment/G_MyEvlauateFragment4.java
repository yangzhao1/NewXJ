...
public class G_MyEvlauateFragment4 extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void getUrlData(String mod,String act,String userid,String state,String pingjia,int pageindexs){
        ...
        Dialog dialog = null;
        String url = Allports.getMyEvaluateUrl(mod,act,userid,state,pingjia,"60",pagesize+"",pageindexs+"");
