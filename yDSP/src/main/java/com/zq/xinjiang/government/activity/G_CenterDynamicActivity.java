...
public class G_CenterDynamicActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void init(){
        ...
        titleText.setText(R.string.center_dynamic);
    ...
    private void refreshRecyclerView(final List<Map> list){
        ...
        adapter.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent in = new Intent(G_CenterDynamicActivity.this,G_NewsDetails.class);
