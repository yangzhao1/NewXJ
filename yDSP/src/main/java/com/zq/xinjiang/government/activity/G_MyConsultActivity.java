...
import com.zq.xinjiang.government.adapter.MyConsultsAdapter;
...
public class G_MyConsultActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener{
    private TextView titleText,back;
    private String titlestr = "咨询投诉";
    ...
    private MyConsultsAdapter adapter = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.g_myconsultmain);
        setStatusColor();
        init();
    }

    private void init(){
        linkmobile = preferences.getString("linkmobile","");
        ...
        getUrlData("op","consultingoflist",loginid,pageindex);
    }

    //我的咨询投诉列表解析
    private void getUrlData(String mod,String act,String userid,int pager){

        String url = Allports.getMyConsultUrl(mod,act,userid,pagesize+"",pager+"",linkmobile);
        Log.e("咨询投诉列表接口：" , url);
    ...
    private void refreshRecyclerView(final List<Map> list){
        ...
        if (pageindex==1){
            layoutManager = new LinearLayoutManager(G_MyConsultActivity.this);
            recyclerView.setLayoutManager(layoutManager);
            adapter = new MyConsultsAdapter(G_MyConsultActivity.this,list);
        ...
        adapter.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if(list.size()!=0) {
                    Intent in = new Intent(G_MyConsultActivity.this,G_InterDetailsActivity.class);
