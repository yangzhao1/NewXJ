...
import com.zq.xinjiang.government.adapter.HotItemAdapter;
...
public class G_HotItemsActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener {
    private TextView titleText;
    private TextView back;
    private RecyclerView recyclerView;
    private List<ItemsList> list;
    private String title = "热点事项";
    ...
    private HotItemAdapter adapter = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.g_hotitems);
        setStatusColor();
        init();
    }
...
//        recyclerView.setItemAnimator(new DefaultItemAnimator());
    ...
    private void getUrlData(final int page,String loginid){
        String url = Allports.getHotItemsListPorts("api","gethotitemlist",pagesize+"",page+"","");
        Log.e("热点事项 ","：" + url);
...
//                                items.setIscollection(obj.getString("iscollection"));
    ...
    private void refreshRecyclerView(final List<ItemsList> list){
        ...
        if (flag){
            layoutManager = new LinearLayoutManager(G_HotItemsActivity.this);
            recyclerView.setLayoutManager(layoutManager);
            adapter = new HotItemAdapter(G_HotItemsActivity.this,list,loginid);
        ...
        adapter.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent in = new Intent(G_HotItemsActivity.this,G_ItemDetailsActivity.class);
