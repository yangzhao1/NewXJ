...
public class G_CenterShowActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void init(){
        ...
        titleText.setText(R.string.center_show);
    ...
    private void refreshRecyclerView(final List<Map> list){
        ...
        adapter.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent in = new Intent(G_CenterShowActivity.this,G_NewsDetails.class);
