package com.zq.xinjiang.government.view;
...
public class ScrllorTabTextView extends View {

    private int mTabNum, mCurrentNum;
    private float mWidth, mTabWidth, mOffset,mWidth_two;
    private final Paint mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
    private int mBeginColor;
    private int mEndColor;
    LinearGradient gradient;

    public ScrllorTabTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
        ...
        final float bottom = getHeight() - getPaddingBottom();
         ...
         if (gradient == null) {
            LinearGradient gradient = new LinearGradient(left, getHeight(), right,
                    getHeight(), 0xFF3D83DD,0xFF3D83DD, Shader.TileMode.CLAMP);
